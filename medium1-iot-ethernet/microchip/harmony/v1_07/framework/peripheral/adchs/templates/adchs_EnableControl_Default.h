...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADCHS_ENABLE_CONTROL_VREG(index)

  MASKs: 
    _ADCHS_ENABLE_CONTROL_MASK(index)

  POSs: 
    _ADCHS_ENABLE_CONTROL_POS(index)

  LENs: 
    _ADCHS_ENABLE_CONTROL_LEN(index)
...
{
	_SFR_BIT_WRITE( _ADCHS_ENABLE_CONTROL_VREG(index),
					_ADCHS_ENABLE_CONTROL_POS(index),
					1 );
}
