...
PLIB_TEMPLATE bool ADCHS_DMASourceSelect_Unsupported( ADCHS_MODULE_ID index , ADCHS_CHANNEL_ID channelID )
{
...
PLIB_TEMPLATE bool ADCHS_DMASourceRemove_Unsupported( ADCHS_MODULE_ID index , ADCHS_CHANNEL_ID channelID )
{
