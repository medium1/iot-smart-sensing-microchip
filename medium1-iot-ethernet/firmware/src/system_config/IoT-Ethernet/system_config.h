...
#define TCPIP_HTTP_DEFAULT_LEN		        		256
...
#define TCPIP_HTTP_CONFIG_FLAGS		        		HTTP_MODULE_FLAG_DEFAULT //HTTP_MODULE_FLAG_ADJUST_SKT_FIFOS
...
#define TCPIP_NETWORK_DEFAULT_HOST_NAME 			"MediumOne_IOT_ETHERNET"
