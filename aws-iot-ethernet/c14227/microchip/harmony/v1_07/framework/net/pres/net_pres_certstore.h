...
bool NET_PRES_CertStoreGetClientCerts(const uint8_t ** clientCertPtr, int32_t * clientCertLen, 
                                  uint8_t certIndex);

bool NET_PRES_CertStoreGetClientKey(const uint8_t ** clientKeyPtr, int32_t * clientKeyLen, 
                                  uint8_t certIndex);
