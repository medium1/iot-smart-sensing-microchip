...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADCHS_TRIG_SENSITIVE_REG_VREG(index)
    _ADCHS_TRIGGER_SUSPEND_CONTROL_VREG(index)
    _ADCHS_TRIGGER_CONTROL_BASE_ADDRESS_VREG(index)
    _ADCHS_ANALOG_INPUT_0_TRIGGER_SEL_VREG(index)
    _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_VREG(index)
    _ADCHS_GLOBAL_SOFT_TRIGGER_VREG(index)

  MASKs: 
    _ADCHS_TRIG_SENSITIVE_REG_MASK(index)
    _ADCHS_TRIGGER_SUSPEND_CONTROL_MASK(index)
    _ADCHS_TRIGGER_CONTROL_BASE_ADDRESS_MASK(index)
    _ADCHS_ANALOG_INPUT_0_TRIGGER_SEL_MASK(index)
    _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_MASK(index)
    _ADCHS_GLOBAL_SOFT_TRIGGER_MASK(index)

  POSs: 
    _ADCHS_TRIG_SENSITIVE_REG_POS(index)
    _ADCHS_TRIGGER_SUSPEND_CONTROL_POS(index)
    _ADCHS_TRIGGER_CONTROL_BASE_ADDRESS_POS(index)
    _ADCHS_ANALOG_INPUT_0_TRIGGER_SEL_POS(index)
    _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_POS(index)
    _ADCHS_GLOBAL_SOFT_TRIGGER_POS(index)

  LENs: 
    _ADCHS_TRIG_SENSITIVE_REG_LEN(index)
    _ADCHS_TRIGGER_SUSPEND_CONTROL_LEN(index)
    _ADCHS_TRIGGER_CONTROL_BASE_ADDRESS_LEN(index)
    _ADCHS_ANALOG_INPUT_0_TRIGGER_SEL_LEN(index)
    _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_LEN(index)
    _ADCHS_GLOBAL_SOFT_TRIGGER_LEN(index)
...
PLIB_TEMPLATE void ADCHS_AnalogInputLevelTriggerSet_Default( ADCHS_MODULE_ID index , ADCHS_CLASS12_AN_INPUT_ID analogInput )
{
	...
	_SFR_BIT_WRITE( _ADCHS_TRIG_SENSITIVE_REG_VREG( index ),
				  analogInput, 1 );
}
...
PLIB_TEMPLATE void ADCHS_AnalogInputTriggerSourceSelect_Default( ADCHS_MODULE_ID index , ADCHS_CLASS12_AN_INPUT_ID inputId , ADCHS_TRIGGER_SOURCE triggerSource )
{
	...
	baseAddr = _ADCHS_TRIGGER_CONTROL_BASE_ADDRESS_VREG(index) + (inputId/4);
	
	pos = (inputId%4);
	
	// First clear the bits before writing
	*(baseAddr) &= ~ (0x0000001F << (pos * 8));
	*(baseAddr) |= (triggerSource << (pos * 8));
}
...
{
	_SFR_BIT_WRITE( _ADCHS_GLOBAL_SOFT_TRIGGER_VREG( index ),
				  _ADCHS_GLOBAL_SOFT_TRIGGER_POS( index ), 1 );
}
...
{
	_SFR_BIT_WRITE( _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_VREG( index ),
				  _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_POS( index ), 1 );
}
...
{
	_SFR_BIT_WRITE( _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_VREG( index ),
				  _ADCHS_GLOBAL_LEVEL_SOFT_TRIGGER_POS( index ), 0 );
}
...
{
	_SFR_BIT_WRITE( _ADCHS_TRIGGER_SUSPEND_CONTROL_VREG( index ),
				  _ADCHS_TRIGGER_SUSPEND_CONTROL_POS( index ), 1 );
}
...
{
	_SFR_BIT_WRITE( _ADCHS_TRIGGER_SUSPEND_CONTROL_VREG( index ),
				  _ADCHS_TRIGGER_SUSPEND_CONTROL_POS( index ), 0 );
}
