...
void SYS_PORTS_Initialize(void)
{
    ...
    /* fixed false motion detection without sensor installed MO-160 9/13/2016 Fai Cheng */
	 PLIB_PORTS_ChangeNoticePullDownPerPortEnable( PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_11 );
